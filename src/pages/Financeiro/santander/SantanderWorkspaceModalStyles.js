// src/pages/Financeiro/Santander/SantanderModalStyles.js
...
export const S = {
  ...
  CovenantRow: styled.div`
    display: flex;
    gap: 8px;
    align-items: center;
    
    /* Usando S.Input diretamente via className ou styled component aninhado */
    & > input {
      flex: 1;
      padding: 10px 14px;
      background: var(--color-bg-secondary);
  ...
  CovenantActions: styled.div`
    display: flex;
    gap: 4px;
  `,

  AddCovenantButton: styled.button`
    display: flex;
    align-items: center;
    justify-content: center;
    width: 38px;
  ...
  RemoveCovenantButton: styled.button`
    display: flex;
    align-items: center;
    justify-content: center;
    width: 38px;
