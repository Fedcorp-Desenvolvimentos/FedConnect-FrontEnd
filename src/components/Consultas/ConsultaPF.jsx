...
//                           <div className="input-copy-group">
//                             <input type="text" value={formatarData(basicData.BirthDate)} disabled />
//                             <button
//                               type="button"
//                               className="copy-btn"
//                               title="Copiar Data de Nascimento"
//                               onClick={() => copiarParaClipboard(formatarData(basicData.BirthDate), "nascimento")}
//                             >
...
//                                       {formatarData(item.BasicData?.BirthDate)}
//                                     </p>
//                                     <p>
