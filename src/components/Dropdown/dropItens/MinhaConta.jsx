...
//             <button
//               className={activeTab === "perfil" ? "tab-aba active" : "tab-aba"}
//               onClick={() => setActiveTab("perfil")}
//             >
//               <i className="bi bi-person-circle"></i> Perfil
//             </button>
//             <button
//               className={activeTab === "senha" ? "tab-aba active" : "tab-aba"}
...
//             <>
//               <h3>
//                 <i className="bi bi-gear"></i> Editar Conta
//               </h3>
...
//                   />
//                   <i
//                     className={`bi ${showSenhaAtual ? "bi-eye-slash" : "bi-eye"}`}
...
//                   />
//                   <i
//                     className={`bi ${showNovaSenha ? "bi-eye-slash" : "bi-eye"}`}
