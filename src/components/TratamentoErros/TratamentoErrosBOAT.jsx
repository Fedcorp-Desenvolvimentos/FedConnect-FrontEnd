// src/pages/Consultas/TratamentoErrosBOAT.jsx (ou onde você organiza suas páginas)
...
const TratamentoErrosBOAT = () => {
  ...
  return (
     <PageLayout
        ...
        subtitle="Execute a procedure para tratar erros de faturamento de forma automática"
      >
...
export default TratamentoErrosBOAT;