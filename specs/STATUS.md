...
| `curso-cipa-historico` | aprovado (2026-09-04) | aprovado (2026-09-04) | aprovado (2026-09-04) — fases A (histórico, consulta, detalhe) e B (download da lista de presença) implementadas; CT-HIS-001..005 pendentes de verificação manual; fase C (aba Presença, RF-HIS-005) implementada em 2026-09-08; **fase D (aba Certificados, RF-HIS-006) implementada em 2026-09-09**; build OK; roteiro dos CT contra o backend pendente |
| `curso-cipa-cadastros` | aprovado (2026-09-09) — página `/condomed/cadastros` (palestrantes e locais); PA-029 fechada; lado backend em `FedConnect-Back-End/specs/curso-cipa-cadastros/` | aprovado (2026-09-09) | aprovado (2026-09-09) — fases 1–2 concluídas, build OK; roteiro dos CT contra o backend pendente || `relatorio-faturas-pendentes` | aprovado (2026-09-09) — página `/financeiro/faturas-pendentes`, um documento por linha, filtros do legado (PA-032 fechada) | aprovado (2026-09-09) | aprovado (2026-09-09) — fase 1 concluída, build OK; fase 2 (roteiro manual com o FedHub) pendente |
