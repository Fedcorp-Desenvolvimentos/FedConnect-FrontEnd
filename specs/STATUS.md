...
| `curso-cipa` | **em revisão** (2026-09-04) | **em revisão** (2026-09-04) | **em revisão** (2026-09-04) — Fases 1–3 na branch `feat/curso-cipa` (sem PR), build OK; Fases 4 (ADR-0005, vínculo no inscrito), 5 (ADR-0006, exclusão) 6 (ADR-0007, planilha) e 7 (ADR-0008, capacidade sinaliza) implementadas; CT-CIP-001..012 pendentes de verificação manual |
