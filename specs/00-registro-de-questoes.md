...
- **Resposta (presença, 2026-09-08):** sem prazo para marcar; não existe presença parcial; qualquer `condomed`/`admin` marca; a turma passa a `realizada` ao registrar presença e a opção manual sai do formulário; lista de presença mantém as linhas em branco, sem horário; histórico guarda tudo. Certificado: respondido em 04/09 (PA-027).
- **Pergunta original:** (mantida abaixo para contexto)
- **Trava:** fases C (presença) e D (certificado) do `../../FedConnect-Back-End/docs/curso-cipa/MAPEAMENTO_CIPA_FASE2.md`. Não trava a fase A (`specs/curso-cipa-historico/`).
...
- **Questão:** os modelos de certificado em uso (`../../FedConnect-Back-End/docs/curso-cipa/ANALISE_CERTIFICADO_CIPA.md`) citam o condomínio com CNPJ e levam o instrutor com registro MTE e assinatura. A tela não pedia nenhum dos dois.
...
## PA-028 — Aba Presença antes do dia da turma

- **Status:** fechada (2026-09-08) · **Dono:** Ingrid Aylana · **Severidade:** baixa
- **Resposta (2026-09-08):** a aba Presença fica desabilitada até a data da turma — **nunca antes**.
...
- **Status:** fechada (2026-09-08) · **Dono:** Ingrid Aylana · **Severidade:** alta
- **Resposta (2026-09-08):** a área é de **qualquer usuário `condomed`** (e `admin`); o cadastro oferece **desativar**, não excluir, e o desativado continua no histórico; o formulário do palestrante já traz o campo da assinatura, opcional.
...
- **Resposta (2026-09-08):** **emissão parcial**: a aba mostra quantos foram emitidos e **avisa em tela quem não foi**, com o motivo e atalho para corrigir.
...
## PA-031 — Turma com certificado emitido é intocável
